...
ex10:-tell('C:/Users/Admin/Documents/Prolog/лр9/in.txt'),not(ex10_),not(exr10),nl,told.

ex10_:-make(7,Pos),sochet(Pos_,3,Pos),in_list_exlude([97,98,99,100,101,102],S1, List),put_73(Word,Pos_,[S1]),in_list_exlude(List,S1_,Pos2),in_free_pos7(Word,S1_),in_list_exlude(Pos2,S2,Pos3),
in_free_pos7(Word,S2), in_list_exlude(Pos3,S3,Pos4),in_free_pos7(Word,S3),in_list_exlude(Pos4,S4,_),in_free_pos7(Word,S4),write_str(Word),nl,fail.

exr10:-make(7,Pos),sochet([H1, H2],2,Pos),in_list_exlude(Pos,H1,Pos1),in_list_exlude(Pos1,H2,Pos2),sochet([H3, H4],2,Pos2),sochet([S1, S2],2,[97,98,99,100,101,102]), in_list_exlude([97,98,99,100,101,102],S1,Symbol1), in_list_exlude(Symbol1,S2,Symbol2),put_7(Word,[H1, H2],S1),put_7(Word,[H3, H4],S2),
